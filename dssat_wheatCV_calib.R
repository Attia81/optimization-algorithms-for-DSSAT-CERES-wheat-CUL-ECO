...
myfunction <- function(X,Optfig){
 ...
 Xbuild[82] = paste(" 2 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I25")
 Xbuild[103] = paste(" 3 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I50")
 Xbuild[124] = paste(" 4 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I75")
 Xbuild[145] = paste(" 5 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I100")
 Xbuild[166] = paste(" 6 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I0")
 Xbuild[175] = paste(" 7 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I25")
 Xbuild[195] = paste(" 8 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I50")
 Xbuild[215] = paste(" 9 ",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I75")
 Xbuild[235] = paste(" 10",formatC(X[20],format="f",digits=2),"   30    50   100 GS000 IR001    10 1997 I100")
